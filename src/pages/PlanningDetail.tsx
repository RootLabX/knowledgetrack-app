...
import { createSprint } from "@/lib/planningApi";
...
const PlanningDetail = () => {
  ...
  const statusKey = plan?.status ?? "in_progress";
            ...
            {plan.planning_sprints
              ...
              .map((sprint) => (
                ...
                >
                  ...
                  <div className={`absolute left-0 top-0 bottom-0 w-1.5 ${statusBorderClasses[sprint.status] || 'bg-gray-300'}`} />
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center p-5 pl-7 gap-5">
                    ...
                    <div className="flex-1 min-w-0 space-y-1">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <Badge variant="secondary" className={`text-xs capitalize font-normal ${statusBadgeClasses[sprint.status]}`}>
